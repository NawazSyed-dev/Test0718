                ...
                faqs: [
                    {
                        ...
                        answer: 'Large rollouts typically involve 50+ locations, multi-provincial deployments, or enterprise-wide implementations. These require specialized project management, bilingual documentation, CSA compliance verification, and custom deployment schedules.'
                    },
                    {
                        question: 'How do I initiate a large rollout project in Canada?',
                        answer: 'Contact your Canadian enterprise account manager or call 1-800-ENTERPRISE-CA. We\'ll assign a bilingual project manager and create a custom deployment plan with timeline, provincial compliance requirements, and milestone tracking.'
                    },
                    {
                        question: 'What additional services are included in Canadian large rollouts?',
                        answer: 'Canadian large rollouts include: dedicated bilingual project management, CSA-compliant staging and configuration, coordinated cross-provincial logistics, bilingual on-site training programs, 24/7 deployment support, and post-deployment optimization.'
                    },
                    {
                        question: 'How are large rollout timelines managed across Canadian provinces?',
                        answer: 'We create detailed project timelines considering provincial regulations, time zones, and customs requirements. Phased deployments with milestone checkpoints, bilingual status meetings, and real-time project dashboards keep all stakeholders informed.'
                    },
                    {
                        question: 'What support is available during Canadian large rollouts?',
                        answer: 'Dedicated bilingual support includes: Canadian enterprise project manager, technical lead engineer, logistics coordinator, training specialist, and 24/7 escalation hotline. War room support available for critical deployment phases with French/English capabilities.'
                    }
                ]
            },
            'order-terminal': {
                ...
                faqs: [
                    {
                        ...
                        answer: 'Orders can be placed through the Canadian enterprise portal, by calling 1-800-ORDER-CA, or through your dedicated Canadian account manager. Provide site details, terminal specifications, GST/HST information, and preferred delivery timeline.'
                    },
                    {
                        question: 'What information is required for Canadian terminal orders?',
                        answer: 'Required information includes: merchant ID, site address, terminal model, configuration requirements, delivery contact, installation preferences, business registration number, GST/HST details, and any provincial-specific requirements or accessories.'
                    },
                    {
                        question: 'What terminal models are available in Canada?',
                        answer: 'Available CSA-certified models include: Terminal Pro X1 (full-service), Compact Station C2 (small business), Mobile Unit M3 (portable), Kitchen Display K4 (restaurant), and Custom Enterprise configurations. All include bilingual documentation.'
                    },
                    {
                        question: 'How long does terminal delivery take in Canada?',
                        answer: 'Standard delivery is 7-10 business days including customs clearance. Express delivery (3-5 days) and overnight options available to major cities. Custom configurations may require 10-14 days. Installation can be scheduled concurrent with delivery.'
                    },
                    {
                        question: 'Can I track my Canadian terminal order?',
                        answer: 'Yes, all orders are trackable through the Canadian customer portal using your order number. Real-time updates include order processing, customs clearance, shipping, and delivery status with bilingual SMS/email notifications.'
                    }
                ]
            },
            'replacement': {
                ...
                faqs: [
                    {
                        ...
                        answer: 'Report equipment issues through the Canadian support portal, call 1-800-REPLACE-CA, or contact your Canadian account manager. Provide serial number, issue description, and urgency level for fastest processing. Bilingual support available.'
                    },
                    {
                        question: 'What is covered under Canadian replacement warranty?',
                        answer: 'Warranty covers manufacturing defects, hardware failures, and normal wear issues in compliance with provincial consumer protection laws. Coverage includes parts, labor, and shipping. Damage from misuse, accidents, or environmental factors may incur charges.'
                    },
                    {
                        question: 'How quickly can I get a replacement in Canada?',
                        answer: 'Critical replacements: 24-48 hours in major cities, 48-72 hours in remote areas. Standard replacements: 3-5 business days. Advance replacement available for critical systems - new unit ships before defective unit return.'
                    },
                    {
                        question: 'What happens to defective equipment in Canada?',
                        answer: 'Defective units must be returned within 10 business days using provided prepaid shipping labels. Failure to return may result in charges. Returned units are processed through Canadian facilities and refurbished or recycled responsibly.'
                    },
                    {
                        question: 'Is there a cost for Canadian replacement services?',
                        answer: 'Warranty replacements are free including shipping and labor. Out-of-warranty replacements incur hardware costs plus service fees. Extended warranty plans available to minimize replacement costs. All pricing in CAD.'
                    }
                ]
            },
            'recovery': {
                title: 'Recovery',
                subtitle: 'Equipment recovery and return procedures for Canada',
                faqs: [
                    {
                        question: 'When is equipment recovery required in Canada?',
                        answer: 'Recovery is required for: lease terminations, merchant closures, equipment upgrades, warranty replacements, and end-of-contract returns. Recovery ensures proper asset management, data security, and compliance with Canadian privacy laws.'
                    },
                    {
                        question: 'How do I schedule equipment recovery in Canada?',
                        answer: 'Schedule recovery through the Canadian customer portal, call 1-800-RECOVERY-CA, or contact your Canadian account manager. Provide equipment list, pickup address, and preferred scheduling window. Bilingual scheduling available.'
                    },
                    {
                        question: 'What preparation is needed for Canadian recovery?',
                        answer: 'Preparation includes: data backup and secure wipe per Canadian privacy laws, equipment cleaning, cable organization, original packaging if available, and ensuring site access for pickup team. Bilingual preparation guides available.'
                    },
                    {
                        question: 'Are there charges for equipment recovery in Canada?',
                        answer: 'Standard recovery is included in Canadian service agreements. Rush recovery, special handling, or failed pickup attempts may incur additional charges. Detailed pricing in CAD available from your Canadian account manager.'
                    },
                    {
                        question: 'What happens if equipment is not returned in Canada?',
                        answer: 'Unreturned equipment may result in charges equal to replacement cost in CAD. Grace periods apply for legitimate delays. Contact Canadian customer service immediately if return issues arise. Provincial consumer protection laws apply.'
                    }
                ]
            },
            'edit-merchant': {
                ...
                faqs: [
                    {
                        ...
                        answer: 'Merchant updates can be made through the Canadian merchant portal, by calling 1-800-MERCHANT-CA, or through your Canadian account manager. Changes require verification and may need supporting documentation. Bilingual support available.'
                    },
                    {
                        question: 'What Canadian merchant information can be updated?',
                        answer: 'Updatable information includes: business name, address, contact details, banking information, processing settings, user access, notification preferences, GST/HST numbers, and provincial registration details. Some changes require approval processes.'
                    },
                    {
                        question: 'How long do Canadian merchant updates take to process?',
                        answer: 'Simple updates (contact info): Immediate. Address changes: 1-2 business days. Banking/processing changes: 3-5 business days for verification and approval. Provincial compliance updates may take additional time. Critical updates can be expedited.'
                    },
                    {
                        question: 'What documentation is required for Canadian updates?',
                        answer: 'Required documentation varies by change type: business license for name changes, utility bills for address changes, bank statements for banking updates, GST/HST certificates for tax updates, and authorization forms for processing changes.'
                    },
                    {
                        question: 'Can I make bulk merchant updates in Canada?',
                        answer: 'Yes, bulk updates available for Canadian enterprise accounts with multiple locations. Use the Canadian bulk update portal or contact your account manager for assistance with large-scale merchant information changes across provinces.'
                    }
                ]
            },
            'edit-order': {
                ...
                faqs: [
                    {
                        ...
                        answer: 'Orders can be modified up to 24 hours before shipping. Contact Canadian customer service at 1-800-EDIT-ORDER-CA or use the Canadian online portal. Some modifications may affect pricing and delivery timeline. Bilingual support available.'
                    },
                    {
                        question: 'What Canadian order details can be changed?',
                        answer: 'Modifiable details include: delivery address, contact information, installation preferences, accessory additions, delivery timing, and provincial tax information. Hardware model changes may require order cancellation and resubmission.'
                    },
                    {
                        question: 'Are there fees for order modifications in Canada?',
                        answer: 'Simple modifications (address, contact) are free. Hardware changes, expedited shipping, or custom configuration changes may incur additional fees in CAD. Fee schedule available from Canadian customer service.'
                    },
                    {
                        question: 'How do I cancel an order in Canada?',
                        answer: 'Orders can be cancelled up to 24 hours before shipping without penalty. Contact Canadian customer service immediately at 1-800-CANCEL-CA. Custom orders or orders in production may incur cancellation fees per Canadian consumer protection laws.'
                    },
                    {
                        question: 'What if I need to change a Canadian order after shipping?',
                        answer: 'After shipping, contact Canadian customer service immediately. Options include: delivery redirection (if possible), return and reorder, or field modification upon delivery. Additional charges may apply. Cross-border changes require customs processing.'
                    }
                ]
            },
            contacts: {
